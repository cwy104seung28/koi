                ...
                <transition name="fade" mode="out-in">
                    ...
                    <form action="javascript:;" method="POST" id="contactForm2" v-if="cat == 2" key="form2">
                        ...
                        <div class="item">
                            ...
                            <div>
                                <textarea name="o_experience_detail" id="o_experience_detail" placeholder="請說明細節"></textarea>
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">
                            ...
                            <div>
                                <textarea name="o_experience2_detail" id="o_experience2_detail" placeholder="請說明細節"></textarea>
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">
