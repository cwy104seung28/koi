                                    ...
                                    <a href="<?= $row2['file_link1'] ?>" target="_blank" class="flex-container align-middle">
                                        ...
                                        <div class="arrow">
                                            ...
                                            <svg class="hide-for-large" id="b" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg" width="68.26" height="37.28" viewBox="0 0 68.26 37.28">
                                                <g id="c" data-name="設計">
                                                    <g>
                                                        <path d="M3.16,37.28c-.9-.53-1.59-1.23-2.07-2.1-.48-.87-.72-1.87-.72-2.99s.24-2.12,.72-3c.48-.88,1.17-1.57,2.07-2.1l.59,.7c-.76,.46-1.33,1.06-1.74,1.82s-.6,1.61-.6,2.57,.2,1.81,.6,2.57c.4,.76,.98,1.36,1.74,1.81l-.59,.72Z" style="fill: #585757;" />
                                                        <path d="M8.16,34.91v-7.7h2.72c.58,0,1.11,.1,1.61,.29,.49,.2,.92,.46,1.29,.81,.37,.35,.65,.75,.86,1.22s.31,.98,.31,1.53-.1,1.07-.3,1.54c-.2,.47-.49,.87-.85,1.21-.37,.35-.8,.62-1.29,.81-.5,.2-1.03,.29-1.61,.29h-2.72Zm1.15-1.03h1.58c.4,0,.78-.07,1.12-.21,.34-.14,.65-.34,.91-.59,.26-.25,.46-.55,.6-.89,.14-.34,.21-.71,.21-1.12s-.07-.77-.21-1.11c-.14-.34-.34-.64-.6-.9-.26-.25-.56-.45-.91-.59-.34-.14-.72-.21-1.12-.21h-1.58v5.63Z" style="fill: #585757;" />
                                                        <path d="M19.18,35.03c-.54,0-1.04-.13-1.48-.38-.44-.26-.79-.61-1.05-1.04-.26-.44-.38-.93-.38-1.47s.13-1.03,.38-1.47c.26-.44,.61-.79,1.05-1.05,.44-.26,.94-.39,1.48-.39s1.05,.13,1.49,.39c.44,.26,.79,.61,1.04,1.05,.26,.44,.38,.93,.38,1.47s-.13,1.03-.38,1.47c-.26,.44-.6,.79-1.04,1.04-.44,.26-.93,.38-1.49,.38Zm0-.97c.34,0,.66-.09,.94-.26,.28-.17,.5-.41,.66-.7,.16-.29,.24-.62,.24-.99s-.08-.68-.25-.97-.38-.52-.66-.7c-.27-.18-.58-.26-.93-.26s-.65,.09-.93,.26c-.28,.18-.5,.41-.66,.7s-.25,.61-.25,.97,.08,.7,.24,.99c.16,.29,.38,.53,.66,.7s.59,.26,.93,.26Z" style="fill: #585757;" />
                                                        <path d="M24.58,34.91l-1.56-5.6h1.07l1.09,4.11,1.28-4.11h.95l1.28,4.11,1.09-4.11h1.03l-1.57,5.6h-1.06l-1.25-4.1-1.27,4.1h-1.07Z" style="fill: #585757;" />
                                                        <path d="M32.07,34.91v-5.6h1.1v.57c.43-.46,.99-.68,1.68-.68,.43,0,.81,.09,1.14,.27,.33,.18,.58,.44,.77,.77,.19,.33,.28,.71,.28,1.14v3.52h-1.1v-3.33c0-.44-.12-.79-.37-1.04-.25-.25-.59-.38-1.03-.38-.29,0-.56,.06-.79,.19-.23,.12-.43,.3-.58,.54v4.03h-1.1Z" style="fill: #585757;" />
                                                        <path d="M38.8,34.91v-7.7l1.1-.21v7.91h-1.1Z" style="fill: #585757;" />
                                                        <path d="M44.35,35.03c-.54,0-1.04-.13-1.48-.38-.44-.26-.79-.61-1.05-1.04-.26-.44-.38-.93-.38-1.47s.13-1.03,.38-1.47c.26-.44,.61-.79,1.05-1.05,.44-.26,.94-.39,1.48-.39s1.05,.13,1.49,.39c.44,.26,.79,.61,1.04,1.05,.26,.44,.38,.93,.38,1.47s-.13,1.03-.38,1.47c-.26,.44-.6,.79-1.04,1.04-.44,.26-.93,.38-1.49,.38Zm0-.97c.34,0,.66-.09,.94-.26,.28-.17,.5-.41,.66-.7,.16-.29,.24-.62,.24-.99s-.08-.68-.25-.97-.38-.52-.66-.7c-.27-.18-.58-.26-.93-.26s-.65,.09-.93,.26c-.28,.18-.5,.41-.66,.7s-.25,.61-.25,.97,.08,.7,.24,.99c.16,.29,.38,.53,.66,.7s.59,.26,.93,.26Z" style="fill: #585757;" />
                                                        <path d="M50.63,35.01c-.4,0-.76-.07-1.07-.21-.31-.14-.55-.34-.73-.6s-.26-.55-.26-.89c0-.53,.2-.94,.6-1.25s.96-.46,1.66-.46c.55,0,1.06,.11,1.53,.32v-.59c0-.4-.12-.7-.35-.9-.23-.2-.57-.3-1.02-.3-.26,0-.52,.04-.8,.12-.28,.08-.59,.2-.94,.36l-.41-.83c.42-.2,.82-.34,1.19-.43s.74-.14,1.11-.14c.73,0,1.29,.17,1.69,.52,.4,.35,.6,.84,.6,1.47v3.72h-1.08v-.48c-.25,.2-.52,.34-.8,.44-.29,.1-.6,.14-.94,.14Zm-1-1.73c0,.27,.12,.49,.35,.66,.23,.17,.53,.25,.91,.25,.29,0,.56-.04,.81-.13s.47-.22,.68-.41v-.95c-.21-.12-.43-.21-.67-.27-.23-.05-.49-.08-.78-.08-.4,0-.72,.08-.95,.25-.23,.17-.35,.39-.35,.68Z" style="fill: #585757;" />
                                                        <path d="M57.78,35c-.52,0-1-.13-1.43-.38s-.77-.6-1.02-1.04c-.25-.44-.37-.93-.37-1.47s.13-1.03,.38-1.46c.25-.43,.6-.78,1.03-1.03,.43-.26,.91-.38,1.44-.38,.31,0,.6,.05,.89,.14s.55,.23,.79,.42v-2.57l1.1-.21v7.91h-1.09v-.54c-.48,.42-1.05,.63-1.72,.63Zm.14-.96c.32,0,.62-.06,.89-.18,.27-.12,.49-.29,.68-.51v-2.52c-.18-.21-.41-.37-.68-.49-.27-.12-.56-.18-.89-.18-.35,0-.67,.08-.96,.25-.29,.17-.51,.4-.68,.69-.17,.29-.25,.62-.25,.98s.08,.7,.25,.99c.17,.29,.4,.53,.68,.7,.29,.17,.6,.26,.96,.26Z" style="fill: #585757;" />
                                                        <path d="M65.46,27.05c.9,.53,1.59,1.23,2.07,2.1,.48,.87,.72,1.87,.72,2.99s-.24,2.12-.72,3c-.48,.88-1.17,1.57-2.07,2.1l-.59-.7c.76-.46,1.33-1.06,1.74-1.82,.4-.75,.6-1.61,.6-2.57s-.2-1.81-.6-2.57c-.4-.76-.98-1.36-1.74-1.81l.59-.72Z" style="fill: #585757;" />
                                                    </g>
                                                    <g>
