        ...
        <div class="indexWrap">
            ...
            <div class="index-text-area">
                <div class="inner-text">
                    ...
                    <div class="center-pic" data-move='{"item": 22, "sec": 1}'><img class="hide-for-large" src="./images/index-center-pic.png" alt=""></div>
...
<script>
    ...
    let $tl_preload2 = gsap.timeline({
        ...
        .to("nav", {
            duration: 0,
            className: "+=not-not-clip flex-container align-justify"
        })
        .to(".index-top-banner .top-text", {
            duration: 1.5,
            x: 0,
