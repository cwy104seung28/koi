...
$query_RecCover = "SELECT * FROM file_set WHERE file_c_id = :file_c_id AND file_type = 'ourteaIconCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_c_id', $colname_RecourteaC, PDO::PARAM_INT);
$RecCover->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text"
                                                                                    class="table_data" id="c_title"
                                                                                    value="<?php echo $row_RecourteaC['c_title']; ?>"
                                                                                    size="50" />
                                                                                <input name="c_id" type="hidden"
                                                                                    id="c_id"
                                                                                    value="<?php echo $row_RecourteaC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title_en" type="text"
                                                                                    class="table_data" id="c_title_en"
                                                                                    value="<?php echo $row_RecourteaC['c_title_en']; ?>"
                                                                                    size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active"
                                                                                    class="table_data" id="c_active">
                                                                        ...
                                                                        <?php if ($totalRows_RecCover > 0) { // Show if recordset not empty 
                                                                                ?>
                                                                            <tr>
                                                                                <td align="center" bgcolor="#e5ecf6"
                                                                                    class="table_col_title">
                                                                                    目前icon圖片<a name="imageEdit"
                                                                                        id="imageEdit"></a></td>
                                                                                <td>
                                                                                    <?php do { ?>
                                                                                        <table width="100%" border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center"><a
                                                                                                        href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=ourteaIconCover'; ?>"
                                                                                                        class="fancyboxEdit"
                                                                                                        title="修改圖片"><img
                                                                                                            ...
                                                                                                            height="16"
                                                                                                            title="修改圖片" /></a><a
                                                                                                        href="image_del.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=ourteaIconCover'; ?>"
                                                                                                        class="fancyboxEdit"
                                                                                                        title="刪除圖片"><img
                                                                                    ...
                                                                                    <table width="100%" border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td> <span
                                                                                                ...
                                                                                                <br>
                                                                                                <span
                                                                                                    class="table_data">圖片說明：</span>
                                                                                                <input
                                                                                                    name="imageCover_title[]"
                                                                                                    type="text"
                                                                                                    class="table_data"
                                                                                                    id="imageCover_title1">
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <input name="submitBtn" type="submit"
                                                                        class="btnType" id="submitBtn" value="送出" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
