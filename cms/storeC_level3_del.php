...
if (isset($_SESSION['selected_storeC_level3'])) {
    $G_selected1 = $_SESSION['selected_storeC_level3'] = $row_RecstoreC['c_link'];
}
$menu_is = "store";
?>
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532" class="table_data">
                                                        <?php echo $row_RecstoreC['c_title_en']; ?>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                            </table>
...
if ((isset($_REQUEST['c_id'])) && ($_REQUEST['c_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $sth->execute();
    $deleteGoTo = "storeC_level3_list.php?delchangeSort=1&selected1=" . $G_selected1;
