                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">數字</td>
                                                    <td width="532" class="table_data">
                                                        <?php echo $row_RecstoreNum['d_title']; ?>
                                                        <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_RecstoreNum['d_id']; ?>" />
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "storeNum_list.php?delchangeSort=1";
