...
if (isset($_SESSION['selected_sampleC'])) {
    $G_selected1 = $_SESSION['selected_sampleC'];
}
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_RecsampleC['d_id']?>" <?php if (!(strcmp($row_RecsampleC[ 'd_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="d_class3" cols="50" rows="12" class="table_data" id="d_class3"></textarea></td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $stat->bindParam(':d_class1', $class1 = 'sample', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "sampleFile", "add");
    ...
    $insertGoTo = "sample_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
