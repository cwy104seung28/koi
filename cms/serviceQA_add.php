...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_date, d_active) VALUES (:d_title, :d_title_en, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_date, :d_active)";
    ...
    $stat->bindParam(':d_class1', $class1 = 'serviceQA', PDO::PARAM_STR);
    ...
    $insertGoTo = "serviceQA_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
