...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_description, d_head, d_body, d_schema, d_date, d_active) VALUES (:d_title, :d_title_en, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_description, :d_head, :d_body, :d_schema, :d_date, :d_active)";
    ...
    $stat->bindParam(':d_class1', $class1 = 'team', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "teamFile", "add");
    ...
    $insertGoTo = "team_list.php?pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
    if (isset($_SERVER['QUERY_STRING'])) {
