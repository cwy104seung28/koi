                                            ...
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        ...
                                                        <input name="c_parent" type="hidden" id="c_parent" value="serviceC" />
                                                    </td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['serviceListCover']['note']; ?>
                                                        </p>
                                                    </td>
                                                </tr> -->
                                            </table>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertGoTo = "serviceC_list.php?pageNum=0&totalRows_RecserviceC=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_c_id=" . $new_data_num . "&change_num=1";
