                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php
                                                        do {
                                                            if (!(strcmp($row_RecdoctorC['c_id'], $row_Recdoctor['d_class2']))) {
                                                            echo $row_RecdoctorC['c_title'];
                                                            }
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "doctor_list.php?delchangeSort=1&selected1=" . $G_selected1 . "&selected2=" . $G_selected2;
