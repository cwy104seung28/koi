                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_content" cols="60" rows="8" class="table_data" id="d_content"></textarea>
                                                    </td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_date, d_active) VALUES (:d_title, :d_title_en, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_date, :d_active)";
