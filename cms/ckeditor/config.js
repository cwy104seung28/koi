...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'NewPage,Print,SelectAll,Scayt,Form,Checkbox,Textarea,TextField,Radio,Select,Button,HiddenField,ImageButton,Strike,Subscript,Superscript,NumberedList,BulletedList,Outdent,Indent,Blockquote,CreateDiv,BidiLtr,BidiRtl,Language,Anchor,Flash,Table,HorizontalRule,PageBreak,Iframe,Format,About,Styles,Format,Font,BGColor,CopyFormatting,RemoveFormat,Save,Smiley,SpecialChar,Templates';
