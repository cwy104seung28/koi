...
$colname_Recdoctor = "-1";
if (isset($_GET['d_id'])) {
    $colname_Recdoctor = $_GET['d_id'];
}

$query_Recdoctor = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recdoctor = $conn->prepare($query_Recdoctor);
$Recdoctor->bindParam(':d_id', $colname_Recdoctor, PDO::PARAM_INT);
$Recdoctor->execute();
$row_Recdoctor = $Recdoctor->fetch();
$totalRows_Recdoctor = $Recdoctor->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Recdoctor, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'doctorCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recdoctor, PDO::PARAM_INT);
$RecCover->execute();
...
$RecFile->bindParam(':file_d_id', $colname_Recdoctor, PDO::PARAM_INT);
$RecFile->execute();
...
if (isset($_SESSION['selected_doctorC'])) {
    $G_selected1 = $_SESSION['selected_doctorC'] = $row_Recdoctor['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecdoctorC['c_id'] ?>" <?php if (!(strcmp($row_RecdoctorC['c_id'], $row_Recdoctor['d_class2']))) {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recdoctor['d_title']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="<?php echo $row_Recdoctor['d_class3']; ?>" size="80">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"><?php echo $row_Recdoctor['d_content']; ?></textarea></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_description" cols="60" rows="4" class="table_data" id="d_description"><?php echo $row_Recdoctor['d_description']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_head" cols="60" rows="4" class="table_data" id="d_head"><?php echo $row_Recdoctor['d_head']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_body" cols="60" rows="4" class="table_data" id="d_body"><?php echo $row_Recdoctor['d_body']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_schema" cols="60" rows="4" class="table_data" id="d_schema"><?php echo $row_Recdoctor['d_schema']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recdoctor['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recdoctor['d_active']))) {
                                                                                    echo "selected";
                                                                                } ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recdoctor['d_active']))) {
                                                                                    echo "selected";
                                                                                } ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                        ...
                                                        <td>
                                                            <?php do { ?>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=doctorCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片" /></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=doctorCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片" /></a></td>
                                                                        <td align="center">&nbsp;</td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recdoctor['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recdoctor['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recdoctor['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recdoctor['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "doctor", "add");
    ...
    $updateGoTo = "doctor_list.php?selected1=" . $_POST['d_class2'] . "&changeSort=1&change_num=" . $_POST['d_sort'] . "&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
