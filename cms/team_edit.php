...
$colname_Recteam = "-1";
if (isset($_GET['d_id'])) {
    $colname_Recteam = $_GET['d_id'];
}

$query_Recteam = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recteam = $conn->prepare($query_Recteam);
$Recteam->bindParam(':d_id', $colname_Recteam, PDO::PARAM_INT);
$Recteam->execute();
$row_Recteam = $Recteam->fetch();
$totalRows_Recteam = $Recteam->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Recteam, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'teamCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recteam, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

// $query_RecteamC = "SELECT * FROM class_set WHERE c_parent = 'teamC' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
// $RecteamC = $conn->prepare($query_RecteamC);
// $RecteamC->execute();
// $row_RecteamC = $RecteamC->fetch();
// $totalRows_RecteamC = $RecteamC->rowCount();

$query_RecFile = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'file'";
$RecFile = $conn->prepare($query_RecFile);
$RecFile->bindParam(':file_d_id', $colname_Recteam, PDO::PARAM_INT);
$RecFile->execute();
$row_RecFile = $RecFile->fetch();
$totalRows_RecFile = $RecFile->rowCount();

$G_selected1 = '';
if (isset($_SESSION['selected_teamC'])) {
    $G_selected1 = $_SESSION['selected_teamC'] = $row_Recteam['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recteam['d_title']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">職位(中文)</td>
                                                    <td width="532">
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="<?php echo $row_Recteam['d_class3']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">職位(英文)</td>
                                                    <td width="532">
                                                        <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_Recteam['d_title_en']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">職稱</td>
                                                    <td width="532">
                                                        <input name="d_class4" type="text" class="table_data" id="d_class4" value="<?php echo $row_Recteam['d_class4']; ?>" size="80">
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*放在名字旁的職稱</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">擅長項目</td>
                                                    <td width="532">
                                                        <input name="d_class5" type="text" class="table_data" id="d_class5" value="<?php echo $row_Recteam['d_class5']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">經歷</td>
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"><?php echo $row_Recteam['d_content']; ?></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_description" cols="60" rows="4" class="table_data" id="d_description"><?php echo $row_Recteam['d_description']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_head" cols="60" rows="4" class="table_data" id="d_head"><?php echo $row_Recteam['d_head']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_body" cols="60" rows="4" class="table_data" id="d_body"><?php echo $row_Recteam['d_body']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_schema" cols="60" rows="4" class="table_data" id="d_schema"><?php echo $row_Recteam['d_schema']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recteam['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recteam['d_active']))) {
                                                                                    echo "selected";
                                                                                } ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recteam['d_active']))) {
                                                                                    echo "selected";
                                                                                } ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td align="center" bgcolor="#e5ecf6" class="table_col_title">目前成員照片<a name="imageEdit" id="imageEdit"></a></td>
                                                        <td>
                                                            <?php do { ?>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=teamCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片" /></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=teamCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片" /></a></td>
                                                                        <td align="center">&nbsp;</td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <td bgcolor="#e5ecf6" class="table_col_title">
                                                            <p class="red_letter">*
                                                                <?php echo $imagesSize['teamCover']['note']; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recteam['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recteam['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recteam['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recteam['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = "UPDATE data_set SET d_title=:d_title, d_title_en=:d_title_en, d_content=:d_content, d_class2=:d_class2, d_class3=:d_class3, d_class4=:d_class4, d_class5=:d_class5, d_class6=:d_class6, d_description=:d_description, d_head=:d_head, d_body=:d_body, d_schema=:d_schema, d_date=:d_date, d_active=:d_active WHERE d_id=:d_id";
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['teamCover']['IW'], $imagesSize['teamCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'teamCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "team", "add");
    ...
    $_SESSION['original_selected'] = $_SESSION['selected_teamC'];

    $updateGoTo = "team_list.php?selected1=" . $_POST['d_class2'] . "&changeSort=1&change_num=" . $_POST['d_sort'] . "&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
