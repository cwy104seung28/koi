                ...
                <td>
                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                ...
                                <td>
                                    <label>
                                        <select name="file_width" class="table_data" id="file_width">
                                            <option value="1" <?php if (!(strcmp(1, $row_RecImage['file_width']))) {
                                                                    echo "selected=\"selected\"";
                                                                } ?>>1個單位</option>
                                            <option value="2" <?php if (!(strcmp(2, $row_RecImage['file_width']))) {
                                                                    echo "selected=\"selected\"";
                                                                } ?>>2個單位</option>
                                            <option value="3" <?php if (!(strcmp(3, $row_RecImage['file_width']))) {
                                                                    echo "selected=\"selected\"";
                                                                } ?>>3個單位</option>
                                        </select>
                                    </label>
                                ...
                                <td>
                                    <label>
                                        <select name="file_height" class="table_data" id="file_height">
                                            <option value="1" <?php if (!(strcmp(1, $row_RecImage['file_height']))) {
                                                                    echo "selected=\"selected\"";
                                                                } ?>>1個單位</option>
                                            <option value="2" <?php if (!(strcmp(2, $row_RecImage['file_height']))) {
                                                                    echo "selected=\"selected\"";
                                                                } ?>>2個單位</option>
                                            <option value="3" <?php if (!(strcmp(3, $row_RecImage['file_height']))) {
                                                                    echo "selected=\"selected\"";
                                                                } ?>>3個單位</option>
                                        </select>
                                    </label>
                        ...
                        <tr>
                            ...
                            <td bgcolor="#e5ecf6" class="table_col_title">
                                <p><span class="red_letter">*<?php echo $not; ?>
                                    </span></p>
                            </td>
                        </tr>
                    </table>
