...
if ($R_pageNum > $totalPages_RecstoreC && $R_pageNum != 0) {
    header("Location:storeC_level3_list.php?pageNum=" . $totalPages_RecstoreC);
}
//修改排序
$G_changeSort = 0;
$G_delchangeSort = 0;
                            ...
                            <form action="storeC_process.php" method="post" name="form1" id="form1">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    ...
                                    <tr <?php if ($i%2==0): ?>bgcolor='#E4E4E4'<?php endif ?>>
                                        ...
                                        <td align="center" class="table_data">
                                            <a href="storeC_level3_edit.php?c_id=<?php echo $row_RecstoreC['c_id']; ?>">
                                        ...
                                        <td align="center" class="table_data"><a href="storeC_level3_edit.php?c_id=<?php echo $row_RecstoreC['c_id']; ?>"><img src="image/pencil.png" width="16" height="16" /></a></td>
                                        <td align="center" class="table_data"><a href="storeC_level3_del.php?c_id=<?php echo $row_RecstoreC['c_id']; ?>"><img src="image/cross.png" width="16" height="16" /></a></td>
                                    </tr>
