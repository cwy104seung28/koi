...
<?php
if (!1) {
    header("Location: centerlock_list.php");
}
...
if (isset($_SESSION['selected_centerlockC'])) {
    $G_selected1 = $_SESSION['selected_centerlockC'];
}
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_ReccenterlockC['d_id']?>" <?php if (!(strcmp($row_ReccenterlockC[ 'd_id'], $G_selected1))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" size="70" />
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"></textarea></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data"><textarea name="d_class3" cols="60" rows="8" class="table_data tiny" id="d_class3"></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                                                    輸入區域的右下角可以調整輸入空間的大小。</p></td>
                                                </tr>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td class="table_data"><textarea name="d_class5" cols="60" rows="8" class="table_data tiny" id="d_class5"></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                                                    輸入區域的右下角可以調整輸入空間的大小。</p></td>
                                                </tr>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">產品介紹圖片</td>
                                                    <td class="table_data"><textarea name="d_class4" cols="60" rows="8" class="table_data tiny" id="d_class4"></textarea></td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $stat->bindParam(':d_class1', $class1 = 'centerlock', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "centerlockFile", "add");
    ...
    $insertGoTo = "centerlock_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
