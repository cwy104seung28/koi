...
$query_RecsampleC = "SELECT * FROM class_set WHERE c_parent = 'sampleC' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php
                                                        do {
                                                            if (!(strcmp($row_RecsampleC['c_id'], $row_Recsample['d_class2']))) {
                                                            echo $row_RecsampleC['c_title'];
                                                            }
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "sample_list.php?delchangeSort=1&selected1=" . $G_selected1 . "&selected2=" . $G_selected2;
