...
$colname_RecstoreBrand = "-1";
if (isset($_GET['d_id'])) {
    $colname_RecstoreBrand = $_GET['d_id'];
}

$query_RecstoreBrand = "SELECT * FROM data_set WHERE d_id = :d_id";
$RecstoreBrand = $conn->prepare($query_RecstoreBrand);
$RecstoreBrand->bindParam(':d_id', $colname_RecstoreBrand, PDO::PARAM_INT);
$RecstoreBrand->execute();
$row_RecstoreBrand = $RecstoreBrand->fetch();
$totalRows = $RecstoreBrand->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_RecstoreBrand, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'storeBrandCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_RecstoreBrand, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

// $query_RecCenterCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'storeBrandCenterCover'";
// $RecCenterCover = $conn->prepare($query_RecCenterCover);
// $RecCenterCover->bindParam(':file_d_id', $colname_RecstoreBrand, PDO::PARAM_INT);
...
$RecFile->bindParam(':file_d_id', $colname_RecstoreBrand, PDO::PARAM_INT);
$RecFile->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_id" type="hidden" id="d_id"
                                                            value="<?php echo $row_RecstoreBrand['d_id']; ?>" />
                                                        <input name="d_title" type="text" class="table_data"
                                                            id="d_title"
                                                            value="<?php echo $row_RecstoreBrand['d_title']; ?>" size="80">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title_en" type="text" class="table_data"
                                                            id="d_title_en"
                                                            value="<?php echo $row_RecstoreBrand['d_title_en']; ?>"
                                                            size="80">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="1" <?php if (!(strcmp(1, $row_RecstoreBrand['d_active']))) {
                                                                echo "selected";
                                                            } ?>>顯示</option>
                                                            <option value="0" <?php if (!(strcmp(0, $row_RecstoreBrand['d_active']))) {
                                                                echo "selected";
                                                            } ?>>不顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <select name="d_active_en" class="table_data" id="d_active_en">
                                                            <option value="1" <?php if (!(strcmp(1, $row_RecstoreBrand['d_active_en']))) {
                                                                echo "selected";
                                                            } ?>>顯示</option>
                                                            <option value="0" <?php if (!(strcmp(0, $row_RecstoreBrand['d_active_en']))) {
                                                                echo "selected";
                                                            } ?>>不顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <?php if ($totalRows_RecCover > 0) { // Show if recordset not empty 
                                                    ...
                                                    <tr>
                                                        <td align="center" bgcolor="#e5ecf6" class="table_col_title">
                                                            目前品牌識別圖片<a name="imageEdit" id="imageEdit"></a></td>
                                                        <td>
                                                            <?php do { ?>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"><a
                                                                                href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=storeBrandCover'; ?>"
                                                                                class="fancyboxEdit" title="修改圖片"><img
                                                                                    src="image/media_edit.gif" width="16"
                                                                                    height="16" title="修改圖片" /></a><a
                                                                                href="image_del.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=storeBrandCover'; ?>"
                                                        ...
                                                        <td bgcolor="#e5ecf6" class="table_col_title">
                                                            <p class="red_letter">*
                                                                <?php echo $imagesSize['storeBrandCover']['note']; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['storeBrandCover']['IW'], $imagesSize['storeBrandCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'storeBrandCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "storeBrand", "add");
    ...
    $updateGoTo = "storeBrand_list.php";
    if (isset($_SERVER['QUERY_STRING'])) {
