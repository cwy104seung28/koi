                                            ...
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        ...
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Rechistory['d_title']; ?>" size="20">
                                                    </td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_Rechistory['d_title_en']; ?>" size="80">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_class2" type="text" class="table_data" id="d_class2" value="<?php echo $row_Rechistory['d_class2']; ?>" size="80">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_content" cols="60" rows="8" class="table_data" id="d_content"><?php echo $row_Rechistory['d_content']; ?></textarea>
                                                    </td>
