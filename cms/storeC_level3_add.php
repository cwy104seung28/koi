...
<?php
if (!1) {
    header("Location: storeC_level3_list.php");
}
$G_selected1 = '';
                                            ...
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        ...
                                                        <input name="c_level" type="hidden" id="c_level" value="3" />
                                                    </td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL = "INSERT INTO class_set (c_title, c_level, c_parent, c_link, c_active) VALUES (:c_title, :c_level, :c_parent, :c_link, :c_active)";
    ...
    // }
    //----------插入圖片資料到資料庫end----------
    $insertGoTo = "storeC_level3_list.php?selected1=" . $_POST['c_link'] . "&pageNum=0&totalRows_RecstoreC=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_c_id=" . $new_data_num . "&change_num=1";
    if (isset($_SERVER['QUERY_STRING'])) {
