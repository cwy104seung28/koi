...
if (isset($_SESSION['selected_serviceC'])) {
    $G_selected1 = $_SESSION['selected_serviceC'];
}
...
// $query_RecserviceY = "SELECT * FROM class_set WHERE c_parent = 'serviceY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
// $RecserviceY = $conn->query($query_RecserviceY);
// $row_RecserviceY = $RecserviceY->fetch();
// $totalRows_RecserviceY = $RecserviceY->rowCount();
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecserviceC['c_id'] ?>" <?php if (!(strcmp($row_RecserviceC['c_id'], $G_selected1))) {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>
                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3" id="addArea">
                                                ...
                                                <tr class="service_content1">
                                                    ...
                                                    <td width="532"><textarea name="service_content[]" type="text" cols="60" rows="8" class="table_data tiny" id="service_content1"></textarea>
                                                    </td>
                                                    ...
                                                    <td width="532">
                                                        <table border="0" cellspacing="2" cellpadding="2">
                                                            <tr>
                                                                ...
                                                                <td><a href="javascript:;" class="table_data addTage">新增服務項目內容</a></td>
                                                        ...
                                                        <table width="100%" border="0" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" class="data">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <span class="table_data">選擇圖片：</span>
                                                                    ...
                                                                    <input name="image_titleCover[]" type="text" class="table_data" id="image_titleCover1">
                                                                </td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $stat->bindParam(':d_class1', $class1 = 'service', PDO::PARAM_STR);
    ...
    if (isset($_POST['service_title'])) {
        ...
        for ($j = 0; $j < count($service_title); $j++) {
            ...
            if ($service_title[$j] != '') {
                ...
                $stat = $conn->prepare($insertSQL);
                $stat->bindParam(':service_d_id', $new_data_num, PDO::PARAM_INT);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "serviceFile", "add");
    ...
    $insertGoTo = "service_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
