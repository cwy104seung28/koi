...
$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'serviceCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recservice, PDO::PARAM_INT);
$RecCover->execute();
...
$RecFile->bindParam(':file_d_id', $colname_Recservice, PDO::PARAM_INT);
$RecFile->execute();
$row_RecFile = $RecFile->fetch();
$totalRows_RecFile = $RecFile->rowCount();

$query_Recservice_tab = "SELECT * FROM service_set WHERE service_d_id = :service_d_id AND service_type='service' ORDER BY service_sort ASC";
$Recservice_tab = $conn->prepare($query_Recservice_tab);
$Recservice_tab->bindParam(':service_d_id', $colname_Recservice, PDO::PARAM_INT);
$Recservice_tab->execute();
// $row_Recservice_tab = $Recservice_tab->fetch();

$totalRows_Recservice_tab = $Recservice_tab->rowCount();
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecserviceC['c_id'] ?>" <?php if (!(strcmp($row_RecserviceC['c_id'], $row_Recservice['d_class2']))) {
                                                                                                                            echo "selected";
                                                                                                                        } ?>>
                                                                    <?php echo $row_RecserviceC['c_title'] ?>
                                                                </option>
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recservice['d_title']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_Recservice['d_title_en']; ?>" size="80">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5" id="addArea">
                                                ...
                                                <?php if ($totalRows_Recservice_tab > 0) {
                                                    $i = 1; ?>
                                                    <?php foreach ($Recservice_tab as $row_Recservice_tab) { ?>

                                                        <tr>
                                                            <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">服務項目內頁標題</td>
                                                            <td width="532"><input name="service_title[]" type="text" class="table_data" id="service_title<?php echo $i; ?>" value="<?php echo $row_Recservice_tab['service_title']; ?>" size="58" />
                                                            </td>
                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">服務項目內容</td>
                                                            <td width="532"><textarea name="service_content[]" cols="60" rows="8" class="table_data tiny" id="service_content<?php echo $i; ?>"><?php echo $row_Recservice_tab['service_content']; ?></textarea></td>
                                                ...
                                                <?php } else { ?>
                                                    <tr class="service_title1">
                                                        <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">服務項目內頁標題</td>
                                                        <td width="532"><input name="service_title[]" type="text" class="table_data" id="service_title1" value="" size="58" />
                                                        </td>
                                                        <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                    </tr>
                                                    <tr class="service_content1">
                                                        <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">服務項目內容</td>
                                                        <td width="532"><textarea name="service_content[]" type="text" class="table_data tiny" id="service_content1"></textarea>
                                                        </td>
                                                    ...
                                                    <td width="532">
                                                        ...
                                                        <table border="0" cellspacing="2" cellpadding="2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="javascript:;" class="table_data addTage">新增服務項目</a></td>
                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recservice['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recservice['d_active']))) {
                                                                                    echo "selected";
                                                                                } ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recservice['d_active']))) {
                                                                                    echo "selected";
                                                                                } ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php do { ?>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=serviceCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片" /></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'] . '&type=serviceCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片" /></a></td>
                                                                        <td align="center">&nbsp;</td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <td bgcolor="#e5ecf6" class="table_col_title">
                                                            <p class="red_letter">*
                                                                <?php echo $imagesSize['serviceCover']['note']; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recservice['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recservice['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recservice['d_sort']; ?>" />
                            </form>
...
<script type="text/javascript">
    ...
    $('.addTage').on('click', function() {
        ...
        var eng = ['a', 'b', 'c', 'd', 'f', 'g', 'h'];

        console.log(rowindex - 1)

        // console.log("service_title = " + $("#service_title" + rowindex - 1).val());
        // console.log("service_title_en = " + $("#service_title_en" + rowindex - 1).val());
        if (($("#service_title" + (rowindex - 1)).val() == "")) {
            alert("尚有標題未填寫!!");
        } else {
            var addTxt = '<tr><td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">服務項目內頁標題</td><td><input name="service_title[]" type="text" class="table_data" id="service_title' + rowindex + '" value="" size="58" /></td><td width="250" bgcolor="#e5ecf6">&nbsp;</td></tr><tr><td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">服務項目內容</td><td><textarea name="service_content[]" cols="60" rows="8" class="table_data tiny ' + eng[rowindex - 1] + '" id="service_content' + rowindex + '"></textarea></td><td width="250" bgcolor="#e5ecf6"><span class="note_letter"></span></td></tr><tr><td bgcolor="#e5ecf6">&nbsp;</td><td bgcolor="#e5ecf6">&nbsp;</td><td bgcolor="#e5ecf6">&nbsp;</td></tr>';
            $('#addArea').append(addTxt);
            $(`.${eng[rowindex - 1]}`).each(function(i, el) {
                CKEDITOR.replace(el, {
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = "UPDATE data_set SET d_title=:d_title, d_title_en=:d_title_en, d_slug=:d_slug, d_content=:d_content, d_class2=:d_class2, d_class3=:d_class3, d_class4=:d_class4, d_class5=:d_class5, d_class6=:d_class6, d_description=:d_description, d_head=:d_head, d_body=:d_body, d_schema=:d_schema, d_date=:d_date, d_active=:d_active WHERE d_id=:d_id";
    ...
    if (isset($_POST['service_title'])) {
        // 先刪除原有的
        $deleteSQL = "DELETE FROM service_set WHERE service_type='service' AND service_d_id=:service_d_id";

        $sth = $conn->prepare($deleteSQL);
        $sth->bindParam(':service_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $sth->execute();
        ...
        for ($j = 0; $j < count($service_title); $j++) {

            $new_sort = $j + 1;

            if ($service_title[$j] != '') {

                $insertSQL = "INSERT INTO service_set (service_d_id, service_type, service_title, service_content, service_sort) VALUES (:service_d_id, :service_type, :service_title, :service_content, :service_sort)";

                $stat = $conn->prepare($insertSQL);
                $stat->bindParam(':service_d_id', $_POST['d_id'], PDO::PARAM_INT);
                $stat->bindParam(':service_type', $class1 = 'service', PDO::PARAM_STR);
                $stat->bindParam(':service_title', $service_title[$j], PDO::PARAM_STR);
                $stat->bindParam(':service_content', $service_content[$j], PDO::PARAM_STR);
                $stat->bindParam(':service_sort', $new_sort, PDO::PARAM_INT);
                $stat->execute();
            }
        }
    } else { //沒資料全刪除
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['serviceCover']['IW'], $imagesSize['serviceCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_type', $type = 'serviceCover', PDO::PARAM_STR);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "service", "add");
    ...
    $_SESSION['original_selected'] = $_SESSION['selected_serviceC'];

    $updateGoTo = "service_list.php?selected1=" . $_POST['d_class2'] . "&changeSort=1&change_num=" . $_POST['d_sort'] . "&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
