...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $sth->execute();
    $updateGoTo = "storeC_level3_list.php?selected1=" . $_POST['c_link'] . "&change_num=1&now_c_id=" . $_POST['c_id'] . "&totalRows_RecstoreC=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
