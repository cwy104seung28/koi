...
$colname_Recsample = "-1";
if (isset($_GET['d_id'])) {
    $colname_Recsample = $_GET['d_id'];
}

$query_Recsample = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recsample = $conn->prepare($query_Recsample);
$Recsample->bindParam(':d_id', $colname_Recsample, PDO::PARAM_INT);
$Recsample->execute();
$row_Recsample = $Recsample->fetch();
$totalRows_Recsample = $Recsample->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Recsample, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'sampleCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recsample, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

$query_RecsampleC = "SELECT * FROM data_set WHERE d_class1 = 'product' AND d_active='1' ORDER BY d_sort ASC";
$RecsampleC = $conn->prepare($query_RecsampleC);
$RecsampleC->execute();
$row_RecsampleC = $RecsampleC->fetch();
$totalRows_RecsampleC = $RecsampleC->rowCount();

$query_RecFile = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'file'";
$RecFile = $conn->prepare($query_RecFile);
$RecFile->bindParam(':file_d_id', $colname_Recsample, PDO::PARAM_INT);
$RecFile->execute();
$row_RecFile = $RecFile->fetch();
$totalRows_RecFile = $RecFile->rowCount();

$G_selected1 = '';
if (isset($_SESSION['selected_sampleC'])) {
    $G_selected1 = $_SESSION['selected_sampleC'] = $row_Recsample['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecsampleC['d_id']?>" <?php if (!(strcmp($row_RecsampleC[ 'd_id'], $row_Recsample[ 'd_class2']))) {echo "selected";} ?>>
                                                                    <?php echo $row_RecsampleC['d_title']?>
                                                                </option>
                                                                <?php
                                                                } while ($row_RecsampleC = $RecsampleC->fetch());
                                                                $rows = $RecsampleC->rowCount();
                                                                if($rows > 0) {
                                                                   $RecsampleC->execute();
                                                                }
                                                                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recsample['d_title']; ?>" size="70" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="<?php echo $row_Recsample['d_class3']; ?>" size="80" />
                                                    </td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class4" type="text" class="table_data" id="d_class4" value="<?php echo $row_Recsample['d_class4']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class5" type="text" class="table_data" id="d_class5" value="<?php echo $row_Recsample['d_class5']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class6" type="text" class="table_data" id="d_class6" value="<?php echo $row_Recsample['d_class6']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <div class="perm" id="perm_1">
                                                            <label for="perm_coffee">
                                                                <input name="perm_coffee" type="checkbox" id="perm_coffee" value="1" <?php if ($row_Recsample[ 'd_data1']==1): ?> checked="checked"
                                                                <?php endif ?>> 咖啡
                                                            </label>
                                                            <label for="perm_brand">
                                                                <input name="perm_brand" type="checkbox" id="perm_brand" value="1" <?php if ($row_Recsample[ 'd_data2']==1): ?> checked="checked"
                                                                <?php endif ?>> 麵包
                                                            </label>
                                                            <label for="perm_wifi">
                                                                <input name="perm_wifi" type="checkbox" id="perm_wifi" value="1" <?php if ($row_Recsample[ 'd_data3']==1): ?> checked="checked"
                                                                <?php endif ?>> wifi
                                                            </label>
                                                            <label for="perm_resturant">
                                                                <input name="perm_resturant" type="checkbox" id="perm_resturant" value="1" <?php if ($row_Recsample[ 'd_data4']==1): ?> checked="checked"
                                                                <?php endif ?>> 餐廳
                                                            </label>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">顏色</td>
                                                    <td class="table_data"><textarea name="d_class3" cols="50" rows="12" class="table_data" id="d_class3"><?php echo $row_Recsample['d_class3']; ?></textarea></td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data" id="d_content"><?php echo $row_Recsample['d_content']; ?></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                                                    輸入區域的右下角可以調整輸入空間的大小。</p></td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recsample['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recsample[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recsample[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                        </select>
                                                    </td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=sampleCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=sampleCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                <td align="center">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['sampleCover']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recsample['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Recsample['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recsample['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recsample['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['sampleCover']['IW'], $imagesSize['sampleCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'sampleCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "sample", "add");
    ...
    $_SESSION['original_selected'] = $_SESSION['selected_sampleC'];

    $updateGoTo = "sample_list.php?selected1=" . $_POST['d_class2'] . "&changeSort=1&change_num=" . $_POST['d_sort'] . "&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
