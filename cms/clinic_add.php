                                            ...
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        ...
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="" size="20">
                                                    </td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_class1, d_date, d_active) VALUES (:d_title, :d_class1, :d_date, :d_active)";
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['clinicCover']['IW'], $imagesSize['clinicCover']['IH']);
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "clinicFile", "add");
    ...
    $insertGoTo = "clinic_list.php?pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
    if (isset($_SERVER['QUERY_STRING'])) {
