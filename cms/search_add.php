                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <textarea name="d_class3" cols="60" rows="8" class="table_data" id="d_class3"></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="d_data5" cols="100" rows="5" class="table_data" id="d_data5"></textarea></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="d_data6" cols="100" rows="5" class="table_data" id="d_data6"></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                                                    輸入區域的右下角可以調整輸入空間的大小。</p></td>
                                                </tr>
                                                <tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data5, d_data6, d_date, d_active) VALUES (:d_title, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data5, :d_data6, :d_date, :d_active)";
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "searchFile", "add");
    ...
    $insertGoTo = "search_list.php?pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
    if (isset($_SERVER['QUERY_STRING'])) {
