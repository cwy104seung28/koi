...
<?php
if (!1) {
    header("Location: caseC_list.php");
}
...
$colname_ReccaseC = "-1";
if (isset($_GET['c_id'])) {
    $colname_ReccaseC = $_GET['c_id'];
}

$query_ReccaseC = "SELECT * FROM class_set WHERE c_id = :c_id";

$ReccaseC = $conn->prepare($query_ReccaseC);
$ReccaseC->bindParam(':c_id', $colname_ReccaseC, PDO::PARAM_INT);
$ReccaseC->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_ReccaseC['c_title']; ?>" size="50" />
                                                                                <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_ReccaseC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <!-- <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title_en" type="text" class="table_data" id="c_title_en" value="<?php echo $row_ReccaseC['c_title_en']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr> -->
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active" class="table_data" id="c_active">
                                                                                    <option value="0" <?php if (!(strcmp(0, $row_ReccaseC[ 'c_active']))) {echo "selected";} ?>>不公佈</option>
                                                                                    <option value="1" <?php if (!(strcmp(1, $row_ReccaseC[ 'c_active']))) {echo "selected";} ?>>公佈</option>
                                                                                </select>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
