                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td id="ryder-cat">
                                                        <select name="d_class4" id="d_class4" class="chosen-select" v-model="nowlevel1">
                                                            <option v-for="l1 in level1" :value="l1.c_id">{{l1.c_title}}</option>
                                                        </select>
                                                        <select name="d_class3" id="d_class3" class="chosen-select" v-model="nowlevel2">
                                                            <option v-for="l2 in level2" :value="l2.c_id">{{l2.c_title}}</option>
                                                        </select>
                                                        <select name="d_class2" id="d_class2" class="chosen-select" v-model="nowlevel3">
                                                            <option v-for="l3 in level3" :value="l3.c_id">{{l3.c_title}}</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">抖音連結</td>
                                                    <td width="532">
                                                        <input name="d_data5" type="text" class="table_data" id="d_data5" size="60" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">小紅書連結</td>
                                                    <td width="532">
                                                        <input name="d_data6" type="text" class="table_data" id="d_data6" size="60" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data7" type="text" class="table_data" id="d_data7" size="60" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <!-- <tr>
...
<script type="text/javascript">
    new Vue({
        ...
        computed: {
            ...
            level3() {
                return this.level3temp.filter((n) => n.c_link == this.nowlevel1 && this.c_data1)
            },
        },
        methods: {},
        watch: {
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $class1 = 'store';
    $insertSQL = "INSERT INTO data_set (d_title, d_title_en, d_slug, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_data5, d_data6, d_date, d_active) VALUES (:d_title, :d_title_en, :d_slug, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_data5, :d_data6, :d_date, :d_active)";
