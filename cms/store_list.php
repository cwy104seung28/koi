...
if ($G_changeSort == 1 || $G_delchangeSort == 1) {
    ...
    if ($G_changeSort == 1) {
        if (isset($_GET['now_d_id'])) {
            header("Location:store_list.php?selected1=" . $G_selected1 . "&selected2=" . $G_selected2 . "&pageNum=" . $_GET['pageNum'] . "&totalRows=" . $_GET['totalRows'] . "#" . $_GET['now_d_id']);
        } else {
            $query1 = ($G_selected1) ? "selected1=$G_selected1" : "";
            $query2 = ($G_selected2) ? "selected2=$G_selected2" : "";
            header("Location:store_list.php?". $query1 ."&". $query2 ."&pageNum=" . $_GET['pageNum'] . "&totalRows=" . $_GET['totalRows']);
        }
    } else if ($G_delchangeSort == 1) {
        header("Location:store_list.php?selected1=" . $G_selected1 . "&selected2=" . $G_selected2 . "&pageNum=" . $_GET['pageNum']);
    }
}
