...
$query_ReccenterlockC = "SELECT * FROM class_set WHERE c_parent = 'centerlockC' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php
                                                        do {
                                                            if (!(strcmp($row_ReccenterlockC['c_id'], $row_Reccenterlock['d_class2']))) {
                                                            echo $row_ReccenterlockC['c_title'];
                                                            }
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php echo $row_Reccenterlock['d_date']; ?>
                                                    </td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                            </table>
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "centerlock_list.php?delchangeSort=1&selected1=" . $G_selected1 . "&selected2=" . $G_selected2;
