...
$ourteaTitle = $DB->row("SELECT * FROM data_set WHERE d_class1='mainteaTitle' AND d_active=1");
// $ourteaIcon  = $DB->query("SELECT * FROM class_set, file_set WHERE c_parent='ourteaC' AND c_data1='yes' AND c_id=file_c_id AND file_type='ourteaIconCover' AND c_active=1 ORDER BY c_sort ASC");
//page end
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="our-teaWrap">
                ...
                <div class="scroll-down">
                    ...
                    <svg class="hide-for-large" id="b" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg" width="145.74" height="30" viewBox="0 0 145.74 30">
                        <g id="c" data-name="設計">
                            <g>
                                <g>
                                    <path class="d" d="M3.05,30c-.98-.58-1.74-1.34-2.26-2.29-.52-.95-.79-2.04-.79-3.26s.26-2.31,.79-3.27c.52-.96,1.28-1.72,2.26-2.29l.65,.77c-.82,.5-1.46,1.16-1.9,1.98-.44,.82-.66,1.76-.66,2.81s.22,1.97,.66,2.8,1.07,1.49,1.9,1.97l-.65,.78Z" />
                                    <path class="d" d="M11.35,27.54c-.67,0-1.32-.13-1.94-.4-.62-.26-1.18-.64-1.66-1.12l.77-.89c.46,.45,.92,.78,1.4,1,.48,.22,.97,.32,1.49,.32,.41,0,.77-.06,1.07-.17,.31-.12,.55-.28,.71-.5s.25-.46,.25-.73c0-.38-.13-.66-.4-.86-.26-.2-.7-.35-1.31-.46l-1.4-.23c-.77-.14-1.34-.38-1.72-.74-.38-.36-.57-.84-.57-1.44,0-.48,.13-.9,.38-1.27,.26-.36,.62-.65,1.09-.85,.47-.2,1.01-.3,1.63-.3s1.21,.1,1.79,.29,1.12,.48,1.59,.85l-.7,.96c-.9-.69-1.82-1.03-2.75-1.03-.37,0-.69,.05-.96,.16-.27,.1-.48,.25-.64,.44-.15,.19-.23,.41-.23,.65,0,.34,.12,.61,.35,.79,.23,.18,.62,.31,1.15,.39l1.36,.23c.89,.14,1.54,.4,1.96,.78s.62,.89,.62,1.55c0,.51-.14,.96-.42,1.35-.28,.39-.67,.69-1.18,.91-.5,.22-1.09,.32-1.75,.32Z" />
                                    <path class="d" d="M19.25,27.53c-.58,0-1.12-.14-1.6-.42-.48-.28-.86-.66-1.13-1.14-.28-.48-.41-1.02-.41-1.61s.14-1.13,.42-1.6c.28-.48,.66-.86,1.13-1.14s1.01-.43,1.59-.43c.46,0,.91,.09,1.34,.26,.43,.18,.8,.42,1.11,.74l-.74,.83c-.23-.26-.49-.45-.78-.58s-.59-.19-.9-.19c-.37,0-.7,.09-1,.28-.3,.18-.54,.44-.71,.76-.18,.32-.26,.68-.26,1.07s.09,.75,.26,1.07c.18,.32,.42,.57,.72,.76,.3,.19,.64,.28,1.02,.28,.31,0,.6-.06,.88-.19s.53-.31,.77-.55l.73,.77c-.32,.33-.69,.58-1.11,.76s-.86,.26-1.31,.26Z" />
                                    <path class="d" d="M23.17,27.42v-6.11h1.2v.78c.19-.29,.43-.51,.71-.68,.28-.16,.61-.25,.97-.25,.25,0,.45,.04,.61,.11v1.08c-.11-.05-.23-.08-.35-.1-.12-.02-.24-.03-.36-.03-.35,0-.66,.09-.94,.28-.27,.19-.49,.46-.65,.82v4.09h-1.2Z" />
                                    <path class="d" d="M30.72,27.54c-.59,0-1.13-.14-1.61-.42-.48-.28-.87-.66-1.15-1.14-.28-.48-.42-1.02-.42-1.61s.14-1.13,.42-1.61c.28-.48,.66-.86,1.15-1.15,.48-.28,1.02-.43,1.61-.43s1.14,.14,1.62,.43,.86,.67,1.14,1.15c.28,.48,.42,1.02,.42,1.61s-.14,1.13-.42,1.61c-.28,.48-.66,.86-1.14,1.14s-1.02,.42-1.62,.42Zm0-1.06c.38,0,.72-.09,1.02-.28,.3-.19,.54-.44,.72-.76,.18-.32,.26-.68,.26-1.08s-.09-.75-.27-1.06c-.18-.32-.42-.57-.72-.76-.3-.19-.64-.29-1.01-.29s-.71,.1-1.01,.29c-.3,.19-.54,.45-.72,.76-.18,.32-.27,.67-.27,1.06s.09,.76,.26,1.08c.18,.32,.42,.57,.72,.76,.3,.19,.64,.28,1.02,.28Z" />
                                    <path class="d" d="M35.58,27.42v-8.4l1.2-.23v8.63h-1.2Z" />
                                    <path class="d" d="M38.73,27.42v-8.4l1.2-.23v8.63h-1.2Z" />
                                    <path class="d" d="M47.55,27.53c-.59,0-1.04-.14-1.36-.41-.31-.28-.47-.68-.47-1.21v-3.59h-1.3v-1.01h1.3v-1.56l1.19-.29v1.85h1.8v1.01h-1.8v3.31c0,.31,.07,.53,.21,.67s.37,.2,.69,.2c.17,0,.32-.01,.45-.04,.13-.02,.27-.06,.43-.11v1.01c-.16,.06-.35,.1-.56,.13-.21,.03-.41,.04-.58,.04Z" />
                                    <path class="d" d="M52.94,27.54c-.59,0-1.13-.14-1.61-.42-.48-.28-.87-.66-1.15-1.14-.28-.48-.42-1.02-.42-1.61s.14-1.13,.42-1.61c.28-.48,.66-.86,1.15-1.15,.48-.28,1.02-.43,1.61-.43s1.14,.14,1.62,.43,.86,.67,1.14,1.15c.28,.48,.42,1.02,.42,1.61s-.14,1.13-.42,1.61c-.28,.48-.66,.86-1.14,1.14s-1.02,.42-1.62,.42Zm0-1.06c.38,0,.72-.09,1.02-.28,.3-.19,.54-.44,.72-.76,.18-.32,.26-.68,.26-1.08s-.09-.75-.27-1.06c-.18-.32-.42-.57-.72-.76-.3-.19-.64-.29-1.01-.29s-.71,.1-1.01,.29c-.3,.19-.54,.45-.72,.76-.18,.32-.27,.67-.27,1.06s.09,.76,.26,1.08c.18,.32,.42,.57,.72,.76,.3,.19,.64,.28,1.02,.28Z" />
                                    <path class="d" d="M63.78,27.53c-.6,0-1.14-.14-1.63-.42-.48-.28-.87-.66-1.15-1.14-.28-.48-.43-1.02-.43-1.61s.14-1.11,.41-1.59c.27-.48,.64-.86,1.1-1.14s.98-.43,1.55-.43,1.07,.14,1.51,.43,.79,.67,1.05,1.15c.26,.48,.39,1.03,.39,1.64v.34h-4.81c.06,.34,.19,.64,.38,.9,.19,.26,.43,.47,.72,.62,.29,.15,.61,.23,.95,.23,.3,0,.58-.05,.86-.14s.51-.23,.69-.4l.77,.76c-.36,.27-.73,.47-1.11,.61-.38,.13-.8,.2-1.25,.2Zm-1.99-3.67h3.61c-.05-.32-.16-.6-.33-.85-.17-.24-.38-.44-.64-.58-.25-.14-.53-.21-.82-.21s-.58,.07-.84,.2c-.26,.14-.47,.33-.64,.57s-.29,.53-.34,.86Z" />
        ...
        <div class="new-drinkWrap flex-container align-center">
            <div class="title">
                <div class="ch"><?= $ourteaTitle['d_title'] ?></div>
                <div class="en">
                    <?= $ourteaTitle['d_title_en'] ?>
                </div>
            </div>
            <ul class="pic">
                ...
                <?php foreach ($ourtea as $row) : ?>
                    <li id="<?= $row['c_id'] ?>" data-where="<?= $i; ?>">
                        ...
                        <div class="drink-changeList">
                            <?php
                            $workTotal = $DB->query("SELECT * FROM data_set WHERE d_class1='ourtea' AND d_class2=? AND d_active=1 AND d_sort!=0 ORDER BY d_sort ASC, d_date DESC", [$row['c_id']]);
                            ...
                            <?php for ($page = 1; $page <= $totalpage; $page++) : ?>
                                ...
                                $work = $DB->query("SELECT * FROM data_set WHERE d_class1='ourtea' AND d_class2=? AND d_active=1 AND d_sort!=0 ORDER BY d_sort ASC, d_date DESC LIMIT ?, ?", [$row['c_id'], $limit, $maxItem]); ?>
                                <ul class="drinkList">
...
<script>
    ...
    $('.drinkList li').hover(function() {
        ...
        $(`.drinkList-pic ul.is-show li:nth-child(${drink+1})`).addClass('is-show').siblings().removeClass('is-show')
    });
    $('.drink-fixedList li.current').next().css('opacity', '0.4').next().css('opacity', '0.2').next().css('opacity', '0.1');
    $('.drink-fixedList li.current').prev().css('opacity', '0.4').prev().css('opacity', '0.2').prev().css('opacity', '0.1');
